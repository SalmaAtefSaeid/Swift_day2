...
class AddViewController: UIViewController {
    ...
    */
    ...
    @IBAction func addMovie(_ sender: UIButton) {
        var movie = Movie(title: titleMovie.text!, image: imageMovie.text!, rating: Float(ratingMoving.text!)!, releaseYear: Int(releaseMovie.text!)!, genre: genreMovie.text!)
        tableView?.addMovie(movie: movie)
